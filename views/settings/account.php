...
$this->title = Yii::t('user', 'Налаштування аккаунту');
    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'new_password')->passwordInput()->label('Новий пароль') ?>

                <hr/>

                <?= $form->field($model, 'current_password')->passwordInput()->label('Поточний пароль') ?>

                <div class="form-group">
                    <div class="col-lg-offset-3 col-lg-9">
                        <?= Html::submitButton(Yii::t('user', 'Зберегти'), ['class' => 'btn btn-block btn-success']) ?><br>
                    </div>
                </div>
